      ...
      rooms.map(room => {
        ...
        $(`#room_${room.id}`).on("click", () => {
          ...
          if (room.id) {
            ...
            Data przyjazdu: <input id="room-from" type="date" min=${todayDate} max=${yearFromTodayDate}><br>
            Data wyjazdu: <input id="room-to" type="date" min=${todayDate} max=${yearFromTodayDate}><br>
