...
!function (e) {
  ...
  !function (t, n) {
    ...
    (C.fn.init = function (e, t, n) {
      ...
      if (n = n || H, "string" == typeof e) {
        ...
        if (r[1]) {
          if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : a, !0)), q.test(r[1]) && C.isPlainObject(t)) for (r in t) {
    ...
    function qe(e, t, n, r, o, i) {
      ...
      if (null == r && null == o ? (o = n, r = n = void 0) : null == o && ("string" == typeof n ? (o = r, r = void 0) : (o = r, r = n, n = void 0)), !1 === o) o = De;else if (!o) return e;
    ...
    C.event = {
      ...
      add: function add(e, t, n, r, o) {
        ...
        if (v) for (n.handler && (n = (i = n).handler, o = i.selector), o && C.find.matchesSelector(ae, o), n.guid || (n.guid = C.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
          ...
          d = g = (s = Ae.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = C.event.special[d] || {}, d = (o ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, c = C.extend({
            type: d,
            origType: g,
            data: r,
            handler: n,
      ...
      special: {
        ...
        click: {
          setup: function setup(e) {
            var t = this || e;
            return ge.test(t.type) && t.click && j(t, "input") && Le(t, "click", Ne), !1;
          },
      ...
      e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ne : De, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && C.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[C.expando] = !0;
    }, C.Event.prototype = {
      constructor: C.Event,
    ...
    C.extend(C.event, {
      trigger: function trigger(e, t, r, o) {
        ...
        if (s = d = u = r = r || a, 3 !== r.nodeType && 8 !== r.nodeType && !St.test(v + C.event.triggered) && (v.indexOf(".") > -1 && (y = v.split("."), v = y.shift(), y.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[C.expando] ? e : new C.Event(v, "object" == _typeof(e) && e)).isTrigger = o ? 2 : 3, e.namespace = y.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : C.makeArray(t, [e]), p = C.event.special[v] || {}, o || !p.trigger || !1 !== p.trigger.apply(r, t))) {
          if (!o && !p.noBubble && !x(r)) {
            for (l = p.delegateType || v, St.test(l + v) || (s = s.parentNode); s; s = s.parentNode) {
              g.push(s), u = s;
            }
          ...
          return e.type = v, o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(g.pop(), t) || !Q(r) || c && m(r[v]) && !x(r) && ((u = r[c]) && (r[c] = null), C.event.triggered = v, e.isPropagationStopped() && d.addEventListener(v, Et), r[v](), e.isPropagationStopped() && d.removeEventListener(v, Et), C.event.triggered = void 0, u && (r[c] = u)), e.result;
        }
      },
    ...
    function Ht(e, t, n, r) {
      ...
      if (Array.isArray(t)) C.each(t, function (t, o) {
        n || Dt.test(e) ? r(e, o) : Ht(e + "[" + ("object" == _typeof(o) && null != o ? t : "") + "]", o, n, r);
    ...
    _t.href = kt.href, C.extend({
      ...
      ajax: function ajax(e, t) {
        ...
        if (y.promise(S), h.url = ((e || h.url || kt.href) + "").replace(Wt, kt.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(I) || [""], null == h.crossDomain) {
          l = a.createElement("a");
        ...
        if (h.data && h.processData && "string" != typeof h.data && (h.data = C.param(h.data, h.traditional)), Ut($t, h, t, S), c) return S;

        for (p in (f = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !It.test(h.type), o = h.url.replace(Pt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(o.length), h.data && (h.processData || "string" == typeof h.data) && (o += (Nt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Rt, "$1"), d = (Nt.test(o) ? "&" : "?") + "_=" + At++ + d), h.url = o + d), h.ifModified && (C.lastModified[o] && S.setRequestHeader("If-Modified-Since", C.lastModified[o]), C.etag[o] && S.setRequestHeader("If-None-Match", C.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && S.setRequestHeader("Content-Type", h.contentType), S.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : h.accepts["*"]), h.headers) {
          S.setRequestHeader(p, h.headers[p]);
        }

        if (h.beforeSend && (!1 === h.beforeSend.call(g, S, h) || c)) return S.abort();

        if (T = "abort", m.add(h.complete), S.done(h.success), S.fail(h.error), r = Ut(Ft, h, t, S)) {
        ...
        function E(e, t, a, s) {
          var l,
              ...
              w,
              T = t;
          c || (c = !0, u && n.clearTimeout(u), r = void 0, i = s || "", S.readyState = e > 0 ? 4 : 0, l = e >= 200 && e < 300 || 304 === e, a && (b = function (e, t, n) {
    ...
    C.ajaxSetup({
      ...
      if (s || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Jt, "$1" + o) : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
      ...
      return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((r = (t = a.implementation.createHTMLDocument("")).createElement("base")).href = a.location.href, t.head.appendChild(r)) : t = a), i = !n && [], (o = q.exec(e)) ? [t.createElement(o[1])] : (o = Se([e], t, i), i && i.length && C(i).remove(), C.merge([], o.childNodes)));
      var r, o, i;
  ...
  n.r(t);
  var r = n.p + "pigiSpaLogo.png",
      o = n.p + "pigiSpa-logo-footer.png",
      i = n(0),
      a = n.n(i),
      s = new Image();
  s.src = r, document.querySelector("#logo").appendChild(s);
  var u = new Image();
  u.src = o, document.querySelector("#logo-small").appendChild(u), a()(function () {
    var e = a()("#register-form"),
        t = e.find("#email"),
        n = e.find("#pass"),
        r = e.find("#pass-repeat"),
        o = a()(".weak"),
        i = a()(".average"),
        s = a()(".strong");

    function u(e) {
      e.preventDefault(), 0 !== t.val().length && 0 !== n.val().length && o.css("background-color", "#f57648"), /(?=.*?[A-Z])(?=.*?[a-z]).{8,}/.test(n.val()) && i.css("background-color", "yellow"), /(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9]).{12,}/.test(n.val()) && s.css("background-color", "greenyellow"), n.val() !== r.val() && console.log("Hasła nie są takie same!");
    }

    t.on("input", u), n.on("input", u);
  });
}]);
